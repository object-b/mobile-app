...
export default () => (
  <Page name="form">
    <Navbar title="Form"></Navbar>

    <Toolbar tabbar labels position="bottom">
      <Link href="/object-list" tabLink tabLinkActive text="Список объектов" iconIos="f7:list" iconMd="material:list"></Link>
      <Link href="/object-map" text="Карта объектов" tabLink iconIos="f7:world" iconMd="material:language"></Link>
    </Toolbar>
